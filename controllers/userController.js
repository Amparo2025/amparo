...
res.render('registration' , {message:"Your registration has been done successfully.Please verify your mail."})
}

else{
    res.render('registration' , {message:"Your registratioon has failed."})
}
...
//For verification link to send it in mail
...
const userLogout = async (req, res) => {
    try {
        req.session.destroy((err) => {
            ...
            res.redirect('/home');  // Redirect to login page after successful logout
        });
    } catch (error) {
        console.log(error.message);
        res.redirect('/home'); // In case of an error, redirect to home
    }
};
